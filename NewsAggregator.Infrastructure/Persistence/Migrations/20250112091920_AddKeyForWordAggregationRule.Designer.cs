...
namespace NewsAggregator.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250112091920_AddKeyForWordAggregationRule")]
    partial class AddKeyForWordAggregationRule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewsAggregator.Domain.Entities.AggregationRule", b =>
                {
                    ...
                    b.HasIndex("WordAggregationPatternId");
            ...
            modelBuilder.Entity("NewsAggregator.Domain.Entities.AggregationRule", b =>
                {
                    ...
                    b.HasOne("NewsAggregator.Domain.Entities.WordAggregationPattern", "WordAggregationPattern")
                        .WithMany()
                        .HasForeignKey("WordAggregationPatternId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("WordAggregationPattern");
                });
            ...
            modelBuilder.Entity("NewsAggregator.Domain.Entities.UserLogin", b =>
                {
                    b.HasOne("NewsAggregator.Domain.Entities.User", null)
                        .WithMany("UserLogins")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
